...
用法:
  python pichuli.py                          # 处理默认文件夹 audio_folder
  python pichuli.py <文件夹路径>               # 处理指定文件夹
  python pichuli.py <文件夹路径> --recursive   # 递归处理子文件夹
...
logger = logging.getLogger("pichuli")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
示例:
  python pichuli.py                          # 处理 audio_folder
  python pichuli.py ./人声样本/人声样本1       # 处理指定文件夹
  python pichuli.py ./audio_folder --cpu     # CPU 推理
  python pichuli.py ./audio_folder --half    # FP16 推理 (省显存)
  python pichuli.py ./audio_folder -r        # 递归处理子文件夹
        """,
    )
    parser.add_argument(
        "folder", nargs="?", default="audio_folder",
        help="音频文件夹路径 (默认: audio_folder)"
    )
    parser.add_argument(
